...
<head>
  ...
  <meta name="description" content="Admin RynCode">
  <title>@yield('title', 'Dashboard · RynCode')</title>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.dashboard') }}">
        <div class="sidebar-brand-icon">
          ...
          @else
            <span class="font-weight-bold">RC</span>
          @endif
        </div>
        <div class="sidebar-brand-text mx-3">{{ $setting->name ?? 'RynCode' }}</div>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>© {{ date('Y') }} {{ $setting->name ?? 'RynCode' }} · Admin Panel</span>
          </div>
        </div>
      </footer>
    </div>
