...
>
  <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
    <div>
      ...
      <p class="text-sm leading-relaxed text-slate-600 dark:text-slate-300 max-w-xl mt-2">Beberapa contoh implementasi RynCode di desa dan institusi pendidikan.</p>
    </div>
  </div>
