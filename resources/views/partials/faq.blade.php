...
>
  <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
    <div>
      ...
      <p class="text-sm leading-relaxed text-slate-600 dark:text-slate-300 max-w-xl mt-2">Beberapa pertanyaan yang sering muncul dari desa, sekolah, dan pelaku UMKM sebelum memulai implementasi RynCode.</p>
    </div>
  </div>
