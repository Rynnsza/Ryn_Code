...
>
  <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
    <div>
      ...
      <p class="text-sm leading-relaxed text-slate-600 dark:text-slate-300 max-w-xl mt-2">RynCode dirancang untuk terhubung dengan ekosistem yang sudah ada: lembaga pendidikan, pemerintah daerah, penyedia payment gateway, dan layanan cloud.</p>
    </div>
