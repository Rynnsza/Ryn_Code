## RynCode Landing & Admin

Proyek ini adalah landing page dan panel admin untuk **RynCode** – platform digital untuk desa, sekolah (SIAKAD), dan UMKM – dibangun dengan **Laravel**, **TailwindCSS**, dan **Alpine.js**, serta **SB Admin 2** untuk area admin.
