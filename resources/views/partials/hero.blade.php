<section id="hero" class="relative overflow-hidden border-b border-slate-200/80 dark:border-slate-800/80">
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 grid lg:grid-cols-2 gap-10 lg:gap-16 items-center relative">
    <div class="space-y-6" x-data="{
      persona: 'desa',
      copy: {
        desa: 'RynCode membantu pemerintah desa mengelola data warga, layanan administrasi, dan transparansi pembangunan secara modern.',
        sekolah: 'RynCode membantu sekolah dasar hingga SMA/SMK mengelola akademik, penilaian, dan komunikasi orang tua dalam satu sistem.',
        umkm: 'RynCode membantu pelaku UMKM desa mengelola katalog produk, stok, dan pesanan secara online dalam satu portal.',
      }
    }">
      ...
      <h1 class="text-4xl sm:text-5xl lg:text-5xl font-semibold tracking-tight text-slate-900 dark:text-slate-100">
        Menghubungkan <span class="text-emerald-500 dark:text-emerald-400">Desa Digital</span>,
        <span class="text-emerald-500 dark:text-emerald-400">SIAKAD</span>, dan
        <span class="text-emerald-500 dark:text-emerald-400">UMKM</span> dalam satu ekosistem.
      </h1>
