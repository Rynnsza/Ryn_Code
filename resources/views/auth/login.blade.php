...
<head>
  ...
  <meta name="description" content="Login Admin - RynCode">
  <title>Login Admin · {{ $setting->name ?? 'RynCode' }}</title>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center mb-4">
                    ...
                    <p class="small text-muted mb-0">{{ $setting->name ?? 'RynCode' }} · Panel pengelolaan konten landing page</p>
                  </div>
